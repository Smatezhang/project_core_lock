package com.itek.library_core.widget;
...
public class ZProgressHUD extends Dialog {
	...
	public static final int APPLE_SPINNER = 3;
	...
	public void setSpinnerType(int spinnerType) {
		switch (spinnerType) {
            ...
            case 2:
                ...
                break;
			case 3:
				ivProgressSpinner.setImageResource(R.anim.round_spinner_apple);
				break;
            default:
                ivProgressSpinner.setImageResource(R.anim.round_spinner_fade);
		}
	...
	public ZProgressHUD  setMessage(String message) { tvMessage.setText(message);return instance; }
