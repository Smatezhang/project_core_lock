...
public class HexUtil {
    ...
    public static void main(String[] args) {
        String srcStr = "867725039148003";
        long mL = Long.parseLong(srcStr);
        String mS ="0" + Long.toHexString(mL);
        //System.out.print(mS);
        byte[] byte_src = new byte[9];
        byte_src[0] = 0x03;
        int j = 1;
        for (int i = 0; i < mS.length(); i+=2) {
            String mSubstring = mS.substring(i, i + 2);
            Long mI = Long.parseLong(mSubstring,16);
            byte b1 = mI.byteValue();
            byte_src[j] = b1;
                    j++;
        }
        System.out.print(byte2HexStr(byte_src));
