...
import com.itek.library_core.bluetooth.scan.BleScanRuleConfig;
import com.itek.library_core.bluetooth.scan.BleScanner;
...
public class BleManager {
    ...
    public BluetoothGatt connect(String mac, BleGattCallback bleGattCallback) {
        String mUpperCase = mac.toUpperCase();

        BluetoothDevice bluetoothDevice = getBluetoothAdapter().getRemoteDevice(mUpperCase);
