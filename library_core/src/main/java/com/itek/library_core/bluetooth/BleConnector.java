...
package com.itek.library_core.bluetooth;
...
import com.itek.library_core.bluetooth.callback.BleIndicateCallback;
...
import com.itek.library_core.bluetooth.callback.BleRssiCallback;
import com.itek.library_core.bluetooth.callback.BleWriteCallback;
import com.itek.library_core.bluetooth.data.BleMsg;
import com.itek.library_core.bluetooth.data.BleWriteState;
import com.itek.library_core.bluetooth.exception.GattException;
import com.itek.library_core.bluetooth.exception.OtherException;
import com.itek.library_core.bluetooth.exception.TimeoutException;
...
public class BleConnector {
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null)
                            notifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new TimeoutException());
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_RESULT: {
                        ...
                        if (notifyCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                notifyCallback.onNotifySuccess(mBleBluetooth.getDevice().getMac());
                            } else {
                                notifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new GattException(status));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_DATA_CHANGE: {
                        ...
                        if (notifyCallback != null) {
                            notifyCallback.onCharacteristicChanged(mBleBluetooth.getDevice().getMac(),value);
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_WRITE_START: {
                        ...
                        if (writeCallback != null) {
                            writeCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new TimeoutException());
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_WRITE_RESULT: {
                        ...
                        if (writeCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                writeCallback.onWriteSuccess(mBleBluetooth.getDevice().getMac(),BleWriteState.DATA_WRITE_SINGLE, BleWriteState.DATA_WRITE_SINGLE, value);
                            } else {
                                writeCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new GattException(status));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_READ_START: {
                        ...
                        if (readCallback != null)
                            readCallback.onReadFailure(mBleBluetooth.getDevice().getMac(),new TimeoutException());
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_READ_RESULT: {
                        ...
                        if (readCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                readCallback.onReadSuccess(mBleBluetooth.getDevice().getMac(),value);
                            } else {
                                readCallback.onReadFailure(mBleBluetooth.getDevice().getMac(),new GattException(status));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_SET_MTU_START: {
                        ...
                        if (mtuChangedCallback != null)
                            mtuChangedCallback.onSetMTUFailure(mBleBluetooth.getDevice().getMac(),new TimeoutException());
                        break;
                    }
                    ...
                    case BleMsg.MSG_SET_MTU_RESULT: {
                        ...
                        if (mtuChangedCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                mtuChangedCallback.onMtuChanged(mBleBluetooth.getDevice().getMac(),value);
                            } else {
                                mtuChangedCallback.onSetMTUFailure(mBleBluetooth.getDevice().getMac(),new GattException(status));
                            }
                        }
                        break;
                    }
    ...
    public void enableCharacteristicNotify(BleNotifyCallback bleNotifyCallback, String uuid_notify,
        ...
        if (mCharacteristic != null
            ...
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new OtherException("this characteristic not support notify!"));
        }
    }
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        if (gatt == null || characteristic == null) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt or characteristic equal null"));
            return false;
        }
        ...
        if (!success1) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt setCharacteristicNotification fail"));
            return false;
        }
        ...
        if (descriptor == null) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new OtherException("descriptor equals null"));
            return false;
        } else {
            ...
            if (!success2) {
                notifyMsgInit();
                if (bleNotifyCallback != null)
                    bleNotifyCallback.onNotifyFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt writeDescriptor fail"));
            }
            return success2;
        }
    }
    ...
    public void writeCharacteristic(byte[] data, BleWriteCallback bleWriteCallback, String uuid_write) {
        if (data == null || data.length <= 0) {
            if (bleWriteCallback != null)
                bleWriteCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new OtherException("the data to be written is empty"));
            return;
        }
        ...
        if (mCharacteristic == null
            ...
            if (bleWriteCallback != null)
                bleWriteCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new OtherException("this characteristic not support write!"));
            return;
        }
        ...
        if (mCharacteristic.setValue(data)) {
            ...
            if (!mBluetoothGatt.writeCharacteristic(mCharacteristic)) {
                writeMsgInit();
                if (bleWriteCallback != null)
                    bleWriteCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt writeCharacteristic fail"));
            }
        } else {
            if (bleWriteCallback != null)
                bleWriteCallback.onWriteFailure(mBleBluetooth.getDevice().getMac(),new OtherException("Updates the locally stored value of this characteristic fail"));
        }
    }
        ...
        if (mCharacteristic != null
            ...
            if (!mBluetoothGatt.readCharacteristic(mCharacteristic)) {
                ...
                if (bleReadCallback != null)
                    bleReadCallback.onReadFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt readCharacteristic fail"));
            }
        } else {
            if (bleReadCallback != null)
                bleReadCallback.onReadFailure(mBleBluetooth.getDevice().getMac(),new OtherException("this characteristic not support read!"));
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (!mBluetoothGatt.requestMtu(requiredMtu)) {
                ...
                if (bleMtuChangedCallback != null)
                    bleMtuChangedCallback.onSetMTUFailure(mBleBluetooth.getDevice().getMac(),new OtherException("gatt requestMtu fail"));
            }
        } else {
            if (bleMtuChangedCallback != null)
                bleMtuChangedCallback.onSetMTUFailure(mBleBluetooth.getDevice().getMac(),new OtherException("API level lower than 21"));
        }
    }
