...
public final class CustomActivityOnCrash {
     ...
     */
    public static void restartApplicationWithIntent(@NonNull AppCompatActivity activity, @NonNull Intent intent, @NonNull CrashConfig config) {
    ...
    public static void restartApplication(@NonNull AppCompatActivity activity, @NonNull CrashConfig config) {
     ...
     * @param config   The config object as obtained by calling getConfigFromIntent.
     */
    public static void closeApplication(@NonNull AppCompatActivity activity, @NonNull CrashConfig config) {
        if (config.getEventListener() != null) {
     ...
     */
    @Nullable
    private static Class<? extends AppCompatActivity> guessRestartActivityClass(@NonNull Context context) {
        Class<? extends AppCompatActivity> resolvedActivityClass;
    ...
    @Nullable
    private static Class<? extends AppCompatActivity> getRestartActivityClassWithIntentFilter(@NonNull Context context) {
        ...
        if (resolveInfos != null && resolveInfos.size() > 0) {
            ...
            try {
                return (Class<? extends AppCompatActivity>) Class.forName(resolveInfo.activityInfo.name);
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    private static Class<? extends AppCompatActivity> getLauncherActivity(@NonNull Context context) {
        Intent intent = context.getPackageManager().getLaunchIntentForPackage(context.getPackageName());
        if (intent != null) {
            try {
                return (Class<? extends AppCompatActivity>) Class.forName(intent.getComponent().getClassName());
            } catch (ClassNotFoundException e) {
                //Should not happen, print it to the log!
     ...
     */
    @NonNull
    private static Class<? extends AppCompatActivity> guessErrorActivityClass(@NonNull Context context) {
        Class<? extends AppCompatActivity> resolvedActivityClass;
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    private static Class<? extends AppCompatActivity> getErrorActivityClassWithIntentFilter(@NonNull Context context) {
