...
public class CrashConfig implements Serializable {
    ...
    private boolean trackActivities = true;   //追踪 activity
    private int minTimeBetweenCrashesMs = 3000;
    private Integer errorDrawable = null;
    private Class<? extends AppCompatActivity> errorActivityClass = null;
    private Class<? extends AppCompatActivity> restartActivityClass = null;
    ...
    @Nullable
    public Class<? extends AppCompatActivity> getErrorActivityClass() {
        return errorActivityClass;
    }

    public void setErrorActivityClass(@Nullable Class<? extends AppCompatActivity> errorActivityClass) {
        this.errorActivityClass = errorActivityClass;
    }

    @Nullable
    public Class<? extends AppCompatActivity> getRestartActivityClass() {
        return restartActivityClass;
    }

    public void setRestartActivityClass(@Nullable Class<? extends AppCompatActivity> restartActivityClass) {
    ...
    public static class Builder {
         ...
         */
        @NonNull
        public Builder errorActivity(@Nullable Class<? extends AppCompatActivity> errorActivityClass) {
         ...
         */
        @NonNull
        public Builder restartActivity(@Nullable Class<? extends AppCompatActivity> restartActivityClass) {
